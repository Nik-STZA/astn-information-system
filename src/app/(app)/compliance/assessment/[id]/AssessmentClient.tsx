...
import type { Prospect } from "@/lib/data/compliance";
...
/* ═══════════════════════════════════════════════════════════════════════ */
export default function AssessmentClient({ prospect, saCountry, enforcement, error }: Props) {
  ...
  const exp = exposureLevel(prospect);
  const risks = buildRisks(prospect);
      ...
      <div ref={containerRef} className="popia-doc">
        ...
        <doc-page size="a4" margin="0.72in">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "0 0 14px" }}>
            <h2 style={S.sectionHead}>Risk assessment</h2>
            <div style={S.sectionRule} />
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, margin: "0 0 26px" }}>
            ...
            <div style={{ gridColumn: "1 / -1", background: "#F9F5EC", border: "1px solid #EFE7D6", borderLeft: "4px solid #C6A24E", borderRadius: 6, padding: "14px 16px", breakInside: "avoid" as const }}>
              ...
              <div style={S.bodySerifXs}>Unusually, POPIA protects the personal information of <strong style={{ fontWeight: 600 }}>juristic persons</strong> (companies and other legal entities) as well as natural persons — so business-to-business data, not only individuals&rsquo; data, falls within scope.</div>
            </div>
          </div>

          {/* ===== NEXT STEPS ===== */}
          <div style={{ display: "flex", alignItems: "center", gap: 12, margin: "0 0 16px", breakInside: "avoid" as const }}>
            <h2 style={S.sectionHead}>Recommended next steps</h2>
            <div style={S.sectionRule} />
          </div>
          ...
          <div style={{ borderTop: "2px solid #141414", padding: "14px 0 0", breakInside: "avoid" as const }}>
            ...
            <p style={{ fontFamily: "'Newsreader', serif", fontWeight: 400, fontSize: 9.5, lineHeight: "1.5", fontStyle: "italic", color: "#9A968B", margin: 0 }}>
              This document is for informational purposes only and does not constitute legal advice. STZA recommends engaging qualified legal counsel for jurisdiction-specific compliance guidance. The DPMI (Data Protection Maturity Index) is a proprietary scoring framework rating African jurisdictions across regulatory maturity, enforcement activity and cross-border complexity. Data sourced from public regulatory records. STZA&reg; is a trading name of Sports Tech Africa Limited (Companies House No. 16850337 &middot; ICO No. C1880558), United Kingdom.
            </p>
          </div>
